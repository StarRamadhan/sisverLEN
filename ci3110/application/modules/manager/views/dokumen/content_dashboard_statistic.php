                ...
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-pink hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number"><?php echo $dataJurnal1Today?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-blue hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number"><?php echo $dataJurnal2Today?></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-orange hover-zoom-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="number"><?php echo $dataJurnal3Today?></div>
                        </div>
                    </div>
                </div>
                </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <div class="card">
            <div class="header">
              ...
              <div class="row clearfix">
                <div class="block-header">
                    <h2>JURNALIST APPROVE THIS MONTH</h2>
                </div>
                <div class="col-lg-4 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box-2 bg-pink hover-zoom-effect">
                        <div class="icon">
